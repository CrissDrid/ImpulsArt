    ...
    <div class="row-SubirObra">
      <div class="col-6">
        <div class="drag-area text-center">
          ...
          <input type="file" name="obra" hidden>
        </div>
        <div class="botones">
      ...
      <div class="col-6">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="col-12">
            ...
            <input type="text" class="form-control" id="firstName" placeholder="Peso ejemplo: 5 kg" value="" required>
          </div>
          <br>
          <div class="col-12">
            <label for="username" class="form-label">Tamaño</label>
            <input type="text" class="form-control" id="username" placeholder="Tamaño ejemplo: 40x80 cm" required>
          </div>
          <br>
          <div class="col-12">
            <label for="username" class="form-label">Cantidad de obras disponibles</label>
            <input type="text" class="form-control" id="username" placeholder="Cantidad" required>
          </div>
          <br>
          <div class="col-12">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <button class="bot w-30 btn btn-primary" type="submit">Subir obra</button>
          </div>
        </form>
      </div>
    </div>
