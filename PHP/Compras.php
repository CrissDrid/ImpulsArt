...
<body>
  ...
  <div id="contenedor" class="contenedor">
    <div>
      <img src="../Imagenes/Img 1.jpg" alt="producto 1">
      <div class="informacion">
        <p>Producto 1</p>
        <p class="precio">$199<span>.99</span></p>
        <a href="Compras map.html">
          <button>Informacion</button>
          </a>
      </div>
    </div>
    <div>
      <img src="../Imagenes/Img 2.jpg" alt="producto 2">
      <div class="informacion">
        <p>Producto 2</p>
    ...
    <div>
      <img src="../Imagenes/Img 3.jpg" alt="producto 3">
      <div class="informacion">
        <p>Producto 3</p>
    ...
    <div>
      <img src="../Imagenes/img 4.jpg" alt="producto 4">
      <div class="informacion">
        <p>Producto 4</p>
    ...
    <div>
      <img src="../Imagenes/Img 5.jpg" alt="producto 5">
      <div class="informacion">
        <p>Producto 5</p>
    ...
    <div>
      <img src="../Imagenes/Img 6.jpg" alt="producto 6">
      <div class="informacion">
        <p>Producto 6</p>
