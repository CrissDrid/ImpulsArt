...
<?php
  ...
  inner join vehiculo on domiciliario.fk_placa = vehiculo.pk_placa where Pk_identificacion='".$Pk_identificacion."'";
...
<!--Crear actualizar datos domiciliario-->
        ...
        <select class="form-select" aria-label="Default select example" value="<?php echo $TipoVehiculo; ?>">
        ...
        <div class="pk_placa">
            <input class="form-control" type="text" name="pk_placato" id="pk_placao" placeholder="Editar placa del vehiculo" value="<?php echo $Pk_placa; ?>">
        </div>
