...
if (isset($_GET['buscar'])) {
    ...
    while ($mostrar = mysqli_fetch_assoc($query)) {
      ...
      <td><?php echo $mostrar['pk_placa']?></td>
      <td><?php echo $mostrar['TipoVehiculo']?></td>
      <td>
        <div>
        <?php echo "<a class='btn btn-outline-primary' href='EditarDomiciliario.php?id=" . $mostrar['PkCod_domiciliario'] . "'>EDITAR</a>";?>
        <?php echo "<a class='btn btn-outline-danger' href='EliminarDomiciliario.php?id=" . $mostrar['PkCod_domiciliario'] . "'>BORRAR</a>";?>
       </div>
    </td>
   </tr>
        <?php
