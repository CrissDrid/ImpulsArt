            ...
            <div class="columna col-12 col-md-4 col-lg-4">
                <nav class="navbar navbar-dark ">
                    <div>
                        ...
                        <div class="offcanvas offcanvas-start " id="offcanvasDarkNavbar"
                            aria-labelledby="offcanvasDarkNavbarLabel">
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel"
                                    onclick="redirectToImpulsArt()" onmouseenter="this.style.cursor='pointer'">ImpulsArt
                                </h5>
                            ...
                            <form class=" d-flex mt-4 me-2 ms-2" role="search">
                                ...
                                <button type="button" class="boton btn btn-primary"><i
            ...
            ?>
                ...
                <div class="col-6">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="username" name="nombreProd"
                            value="<?php echo $NombreProducto; ?>" placeholder="nombre" required>
                    </div>
                    <br>
                    <div class="col-12">
                        <label for="username" class="form-label">Costo</label>
                        <input type="text" class="form-control" name="costo" value="<?php echo $Costo; ?>" id="username"
                            placeholder="$" required>
                    </div>
                    <br>
                    <div class="col-12">
                        <label for="firstName" class="form-label">Peso</label>
                        <input type="text" class="form-control" name="peso" value="<?php echo $Peso; ?>" id="firstName"
                            placeholder="Peso ejemplo: 5 kg" value="" required>
                    </div>
                    <br>
                    <div class="col-12">
                        <label for="username" class="form-label">Tamaño</label>
                        <input type="text" class="form-control" name="tamaño" value="<?php echo $Tamaño; ?>"
                            id="username" placeholder="Tamaño ejemplo: 40x80 cm" required>
                    </div>
                    <br>
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="cantidad" value="<?php echo $Cantidad; ?>"
                            id="username" placeholder="Cantidad" required>
                    </div>
                    <br>
                    <div class="col-12">
                        <label for="username" class="form-label">Categoria de la obra</label>
                        <input type="text" name="categoria" value="<?php echo $Categoria; ?>" class="form-control"
                            id="username" placeholder="Categoria (pintura, maqueta, ceramica, etc)" required>
                    </div>
                    <br>
                    <div class="col-12">
                        <label for="username" class="form-label">Descripción</label>
                        <br>
                        <input name="descripcion" value="<?php echo $Descripcion; ?>" id="desc" rows="5"
                            placeholder="Escribe tu descripción aquí..." class="description form-control"></input>
